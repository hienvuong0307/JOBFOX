<template>
    <div>
        ...
        <div class="mt-[5rem]"><OurMinds></OurMinds></div>
        <div class="mt-[5rem]"><QuestionAnswers></QuestionAnswers></div>
    </div>
</template>
  
  <script setup>
import { ref } from 'vue';
import ServiceJob from '~/components/AboutUs/ServicesJob.vue';
import OurMinds from '~/components/AboutUs/OurMinds.vue';
import QuestionAnswers from '~/components/AboutUs/QuestionAnswers.vue';
const items = ref([{ label: 'JOBNOVA' }, { label: 'ABOUT US' }]);
</script>
