<template>
    <div class="fixed inset-0 w-full h-screen flex justify-center items-center bg-cover bg-center bg-no-repeat"
        ...
        <div class="absolute justify-center ">
            <div class="shadow-[0_0_3px_#1e293b26] rounded-[6px] p-6 w-[600px] h-auto bg-[#f8f9fc]">
                ...
                <div class="mt-6 text-center font-extrabold text-lg">REGISTER YOUR ACCOUNT RECRUITER</div>

                <div class="mt-4">
                    <label class="font-semibold">Username</label>
                    <input v-model="username" type="text" placeholder="Name" class="input-field" />
                </div>
                ...
                <div class="flex justify-center mt-4 text-sm text-gray-600">
                    ...
                    <nuxt-link to="/auth/loginrecruiter" class="ml-2 font-semibold text-blue-500 hover:underline">
...
const handleSignup = async () => {
    ...
    if (!username.value || !company.value || !email.value || !password.value || !confirmPassword.value) {
        errorMessage.value = "Vui lòng điền đầy đủ thông tin!";
        return;
    }

    if (company.value.length < 2) {
        errorMessage.value = "Tên công ty phải có ít nhất 2 ký tự!";
        return;
    }
