        ...
        <div class="absolute mr-[55rem]">
            <div class="shadow-[0_0_3px_#1e293b26] rounded-[6px] p-6 w-[355px] h-auto bg-white">
                ...
                <div class="flex justify-start mt-4">
                    <span class="text-[1.2rem] font-light text-[#94a3b8]">Please enter your email address. You will receive a link to create a new password via email.</span>
                </div>
                ...
                <div style="display: grid; align-items: center; justify-content: center; margin-top: 1.5rem; margin-left: 0.8rem">
                    <Button label="SEND" class="!h-12 text-white mr-2 text-[12px] w-[315px] font-bold" style="box-shadow: 0 3px 5px 0 #3b82f61a; width: 315px; background-color: #3b82f6 !important; border: 1px solid #3b82f6 " />
                </div>
