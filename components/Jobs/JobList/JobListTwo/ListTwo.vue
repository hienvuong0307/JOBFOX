                    ...
                    <div class="w-full bg-white rounded-lg shadow-lg p-4">
                        <div class="mt-5 space-y-5">
                                ...
                                <div class="card flex justify-start ml-[-1rem] mt-[-1rem]">
                                    <div class="flex flex-col gap-4">
                                        <div v-for="category in categories" :key="category.key"
                                            ...
                                            <span
                                                class="bg-[#3b82f60d] text-[#3b82f6] text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full ml-auto">
                                                {{ category.count }}
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <Button label="SEND MESSAGE"
                                ...
                                style="background-color: #0b63f3; border-color: #0b63f3; color: #fff" />
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="flex items-center gap-4 p-4">
                                            ...
                                            <div class="flex flex-col flex-1">
                                                ...
                                                <span class="text-[13px] opacity-75"><i
                                                        class="pi pi-clock opacity-75" style="font-size: 13px;"></i> {{ item.desc }}</span>
                                            </div>

                                            <div class="flex flex-col flex-1">
                                                <div class="text-[16px] flex items-center text-gray-500 gap-1"><i
                                                        class="pi pi-map-marker text-gray-400"></i> {{ item.country }}
                                                </div>
                                                <span class="text-[16px] opacity-75 flex items-center gap-1"> <i
                                                        class="pi pi-dollar text-blue-500"></i> {{ item.salarytwo }}/mo
                                                </span>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-3">
                                                <Button icon="pi pi-bookmark" severity="secondary" rounded
                                                    ...
                                                    style="color: #3b82f6; background-color: #3b82f60d; width: 34px; height: 34px" />
                                                <Button :label="'APPLY NOW'"
                                                    style="background-color: #0b63f3; color: #ffffff" iconPos="right"
                                                    class="text-[14px] px-6 py-3 w-[126   55px] h-[34px]"
                                                    size="small" />
                                            </div>
                                        </div>
                                    </template>
