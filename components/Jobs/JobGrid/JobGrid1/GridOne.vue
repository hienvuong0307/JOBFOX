                ...
                <Card style="overflow: hidden; box-shadow: 0 0 3px #1e293b26">
                  <template #header>
                    <div class="flex items-center flex-1 m-5">
                      <div class="bg-white border w-15 h-15 border-slate-100 border-solid rounded-lg absolute mb-[4rem]" style="box-shadow: 0 5px 13px #1e293b33; border-radius: 6px">
                  ...
                  <template #subtitle>
                    <p class="text-xl opacity-75">Digital Marketing Solutions for Tomorrow</p>
                  ...
                  <template #footer>
                    <div class="flex items-center justify-between gap-2 m-2 mb-1">
                      ...
                      <p class="text-xl text-[#3b82f6]">40 Jobs</p>
                    </div>
                  </template>
                </Card>
              </div>
