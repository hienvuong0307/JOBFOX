                        ...
                        <Card style="overflow: hidden; box-shadow: 0 0 3px #1e293b26; border: 2rem">
                            ...
                            <template #footer>
                                <div class="flex gap-3 m-2">
                                    <Tag style="background-color: #3b82f60d; color: #3b82f6; width:72px;" :value="item.type" />
                                    <span class="text-[14px] opacity-75 ml-[9rem]"><i class="pi pi-dollar" style="color: #3b82f6"></i> {{ item.salarytwo }}/mo</span>
                                </div>
